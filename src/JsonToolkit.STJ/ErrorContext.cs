...
public class ErrorContext
{
    ...
    public static ErrorContext ForTypeConversion(Type expectedType, Type? actualType = null,
        object? attemptedValue = null, string? propertyPath = null, string? operation = null)
    {
        return new ErrorContext
        {
    ...
    public static ErrorContext ForConverter(string converterName, string? propertyPath = null, string? operation = null,
    ...
    public static ErrorContext ForValidation(string propertyPath, object? attemptedValue = null,
