...
public static class JsonPath
{
    ...
    public static async IAsyncEnumerable<T> QueryAsync<T>(JsonElement element, string path,
        ...
        while (i < path.Length)
        {
            ...
            else if (path[i] == '[')
            {
                ...
                else if (content.Length > 0 && content[0] == '?')
                {
                    ...
                    if (filterContent.Length >= 2 && filterContent[0] == '(' &&
                        filterContent[filterContent.Length - 1] == ')')
                ...
                else if (content.Length >= 2 && content[0] == '\'' && content[content.Length - 1] == '\'')
                {
                    tokens.Add(new PathToken
                        { Type = TokenType.Property, Property = content.Substring(1, content.Length - 2) });
                }
                else
                {
