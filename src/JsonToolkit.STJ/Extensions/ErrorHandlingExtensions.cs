...
public static class ErrorHandlingExtensions
{
    ...
    public static JsonToolkitException WithContext(this Exception exception, ErrorContext context,
        string? message = null)
    {
    ...
    public static JsonToolkitException WithReaderContext(this Exception exception, ref Utf8JsonReader reader,
        string? operation = null, string? message = null)
    {
