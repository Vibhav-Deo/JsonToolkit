...
namespace JsonToolkit.STJ
{
    ...
    public class JsonPathException : JsonToolkitException
    {
        ...
        public JsonPathException(string message, string? jsonPath = null, int position = -1, string? propertyPath = null, string? operation = null, JsonElement? sourceElement = null)
        ...
        /// <param name="operation">The operation being performed when the error occurred.</param>
        /// <param name="sourceElement">The JSON element that caused the error.</param>
        public JsonPathException(string message, Exception innerException, string? jsonPath = null, int position = -1, string? propertyPath = null, string? operation = null, JsonElement? sourceElement = null)
