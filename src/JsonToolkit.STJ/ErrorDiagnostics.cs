...
namespace JsonToolkit.STJ
{
    ...
    public static class ErrorDiagnostics
    {
        ...
        private static void GenerateRecommendations(ErrorDiagnosticResult result)
        {
            ...
            {
                recommendations.Add("Resolve converter conflicts by adjusting converter precedence or removing duplicate converters");
            }
        ...
        private static void GenerateConverterRecommendations(ConverterErrorDiagnostic diagnostic)
        {
            ...
            {
                recommendations.Add("Multiple converters are registered for the same type - consider removing duplicates or adjusting precedence");
            }
        ...
        private static List<string> IdentifyValidationPatterns(List<ValidationError> errors)
        {
            ...
            {
                patterns.Add($"Multiple validation errors on properties: {string.Join(", ", propertiesWithMultipleErrors)}");
            }
