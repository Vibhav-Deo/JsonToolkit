...
public class JsonPatchException : JsonToolkitException
{
    ...
    public JsonPatchException(string message, JsonPatchOperation? failedOperation = null, int operationIndex = -1,
    ...
    /// <param name="operation">The operation being performed when the error occurred.</param>
    /// <param name="sourceElement">The JSON element that caused the error.</param>
    public JsonPatchException(string message, Exception innerException, JsonPatchOperation? failedOperation = null,
        int operationIndex = -1, string? propertyPath = null, string? operation = null,
