...
public static class JsonSerializerExtensions
{
    ...
    /// <exception cref="JsonToolkitException">Thrown when serialization fails with enhanced context.</exception>
    public static async Task SerializeEnhancedAsync<T>(Stream stream, T value, JsonSerializerOptions? options = null,
    ...
    /// <exception cref="JsonToolkitException">Thrown when deserialization fails with enhanced context.</exception>
    public static async Task<T> DeserializeEnhancedAsync<T>(Stream stream, JsonSerializerOptions? options = null,
        CancellationToken cancellationToken = default)
    {
        if (stream == null)
            throw new ArgumentNullException(nameof(stream));
