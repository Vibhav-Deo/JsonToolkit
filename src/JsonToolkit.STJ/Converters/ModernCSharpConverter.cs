...
public class ModernCSharpConverter<T> : JsonConverter<T> where T : class
{
        ...
        foreach (var constructor in constructors)
        {
            ...
            if (allFound)
            {
                ...
                if (instance != null)
                {
                    ...
                    var constructorParamNames = new HashSet<string>(parameters.Select(p => p.Name ?? ""),
    ...
    private static void SetRemainingProperties(T instance, JsonElement root, HashSet<string> constructorParams,
